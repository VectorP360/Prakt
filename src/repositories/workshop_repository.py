...
from src.schemas.workshop import WorkshopOut, WorkshopIn
...
class WorkshopRepository:
    ...
    def get_by_ID(self, workshop_id: str) -> Optional[WorkshopOut]:
        ...
        cursor.execute(
            """SELECT workshop_id, name FROM workshop WHERE workshop_ID = %s""",
            (workshop_id,),
        )
    ...
    def get_all(self) -> List[WorkshopOut]:
        ...
        cursor.execute(
            """SELECT workshop_id, name FROM workshop ORDER BY workshop_ID;"""
        )
    ...
    def delete(self, workshop_id: int) -> bool:
        ...
        cursor.execute(
            """DELETE FROM workshop WHERE workshop_ID = %s""", (workshop_id,)
        )
        self.__connection.commit()
