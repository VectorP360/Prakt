...
class FacilityOut:
    def __init__(self, facility_id: int, name: str, type: FacilityTypeOut, workshop: WorkshopOut, scada_schema: ScadaSchemeOut):
...
class FacilityIn:
    def __init__(self, name: str, type: FacilityTypeOut, workshop: WorkshopOut, scada_schema: ScadaSchemeOut):
        self.name = name
        self.type = type
        self.workshop = workshop
